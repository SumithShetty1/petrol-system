...
class AdminDashboardView(APIView):
    ...
    def get(self, request):
        ...
        data = admin_sales_summary(start_date, end_date)
...
# -----------------------------------
class AdminPumpDetailDashboardView(APIView):

    permission_classes = [IsAuthenticated, IsAdmin]

    def get(self, request, pump_code):

        pump = get_object_or_404(Pump, pump_code=pump_code)
...
class OwnerDashboardView(APIView):
    ...
    def get(self, request):
        ...
        data = owner_sales_summary(request.user, start_date, end_date)
        return Response(data)
...
# -----------------------------------
class OwnerPumpDetailDashboardView(APIView):
...
class PumpDashboardView(APIView):
    ...
    def get(self, request):
        ...
        data = pump_sales_summary(employee.pump, start_date, end_date)
        return Response(data)
...
class AttendantDashboardDetailView(APIView):
    ...
    def get(self, request, phone):
        ...
        if not attendant.pump or attendant.pump != manager_employee.pump:
