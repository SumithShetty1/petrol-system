...
import { updateAttendant } from "../../services/authService";
...
export default function EditAttendantModal({
    isOpen,
    onClose,
    onSuccess,
    attendant,
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await updateAttendant(attendant.user_id, payload);
            onSuccess();
            handleClose();
        } catch (err: any) {
            ...
            // FALLBACK ERROR
            setApiError("Failed to update attendant. Please try again.");
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="bg-gradient-to-br from-blue-500 to-blue-600 px-6 py-5 relative">
                        ...
                        <p className="text-white/80 text-sm mt-1">
                            Update attendant account details
                        </p>
                    </div>
