...
export default function AddPumpModal({
  isOpen,
  onClose,
  onSuccess,
  onSubmit,
  ...
  const validate = () => {
    ...
    if (!form.pump_code.trim()) {
      newErrors.pump_code = "Pump code is required";
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        pump_code: form.pump_code.toUpperCase().trim(),
      ...
      if (data?.pump_code) {
        setErrors((prev) => ({
          ...prev,
          pump_code: "Pump code already exists",
        }));
        return;
      }
      ...
      setApiError("Failed to create pump. Please try again.");
    } finally {
      setLoading(false);
    }
  };
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Enter unique pump code"
