    ...
    >
      ...
      <td className="px-3 py-3 whitespace-nowrap">
        <div className="flex items-center gap-1">
          <Droplet
            className={`w-3 h-3 ${
              transaction.fuel_type === "petrol" ? "text-blue-500" : "text-orange-500"
            }`}
          />
          <span
            className={`text-xs font-medium ${
              transaction.fuel_type === "petrol" ? "text-blue-700" : "text-orange-700"
            }`}
          >
      ...
      <td className="px-3 py-3 whitespace-nowrap">
        <div className="flex items-center gap-1">
          ...
          <span className="text-gray-600 text-xs">{transaction.pump_location || "—"}</span>
        </div>
      </td>
